...
pub fn preparse_layer4(proto_num:usize, l4: &[u8], packet: & mut PacketSummary) -> (u16, usize)
{
    ...
    match proto_num {
        PROTO_TYPE_TCP   => return (parse_tcp_simple(l4, packet), 20),

        PROTO_TYPE_UDP   => return (parse_udp_simple(l4, packet), 8),

        PROTO_TYPE_ICMP   => return (parse_icmp_simple(l4, packet), 4),
        _   => {
